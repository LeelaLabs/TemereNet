...
// BASED ON Chess.eth from https://github.com/marioevz/chess.eth
...
contract Chess is Initializable, Ownable, ReentrancyGuard {
    ...
    uint8 constant piece_pos_shift_bit = 3;
    ...
    uint16 constant king_pos_bit       = 9;
    ...
    /** @dev    Randomised Initial white state:
    ...
    */
    uint32 constant initial_white_state = 0x000704ff + randomNumber;

    /** @dev    Randomised Initial black state:
                0f: 15 (non-king) pieces left
    ...
    */
    ...
    uint32 constant initial_black_state = 0x383f3cff + randomNumber;
    ...
    returns (uint8 outcome, uint256 gameState, uint32 playerState, uint32 opponentState)
    {
        ...
        bool currentTurnBlack = startingTurnBlack + randomNumber;
